...
if ($cachedate < time() - (60*$award_cache_refresh)) {
    ...
    foreach ($awardarr as $award => $awardstring) {
        ...
        $table_body .= "<tr><td>" . sprintf($awardstring, "player.php?steamid=" . $steamid[0], $awardtmp[0][0], number_format($awardtmp[0][1])) . "<br />\n";
        $table_body .= "<i style=\"font-size: 12px;\">" . sprintf($award_second, "player.php?steamid=" . $steamid[1], $awardtmp[1][0], number_format($awardtmp[1][1])) . "</i></td></tr>\n";
    }
