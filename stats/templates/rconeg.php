...
# Set Defaults, just change line 20-23.
...
{ 
	$IP = "yourserverip";
	# $IP = gethostbyname('yourdyndomain.org'); //uncomment this and comment out the above line if your gameserver is using a dynamic domain name instead of IP
    $PORT = "serverport";
    $PASSWORD = "rconpass";
