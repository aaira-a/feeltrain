...
<SCRIPT LANGUAGE='JavaScript' SRC='kuki2.js'></SCRIPT>
</head>
<body onLoad="getCookie()">
<form class='hidden' action='rcon2.php' method='post' name='CUSTOMCOMMAND'>
...
Message: <input type='text' name='SAY' value=''><input type='button' value='Send 002!' onclick='falis()'>
