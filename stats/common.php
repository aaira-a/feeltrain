...
$campaigns = array("l4d_hospital" => "No Mercy",
...
while ($row = mysql_fetch_array($result)) {
    $top10[] = "<b>" . $i . " ) <a href=\"player.php?num=" . $row['num'] . "\">" . htmlentities($row['name'], ENT_COMPAT, "UTF-8") . "</a></b> (" . number_format($row['points']) . " Points)";
    $i++;
}
?>
